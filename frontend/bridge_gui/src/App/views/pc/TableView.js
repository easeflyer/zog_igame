      ...
      <div>
        ...
        <div id='table' className='table'>
          <div id='header' className='header'>
            ...
            <div onClick={table.openDebug} className='re seats'>
              <Seats dealer={tableStore.dealer} logicDealer={tableStore.logicDealer} vul={tableStore.state.vulnerable}
                sequence={tableStore.sequence} cbd={tableStore.cbd} />
            </div>
