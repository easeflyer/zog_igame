...
function suits(suit,num){
   return (<span style={{height:"12px"}}><img src={suit} style={{width:"12px",height:"12px"}}/>{num}</span>)
}
const callData=[
...
const resultData=[
    {result:<span>W 3<img src={'/cards/club.svg'} style={{width:"12px"}}/> X</span>,first:<span>2<img src={'/cards/club.svg'} style={{width:"12px"}}/></span>,snscore:'',ewscore:140,nsimp:'',ewimp:1},
    {},
    {},
    {},
    {}
